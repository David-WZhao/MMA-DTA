...
def process_pdb_id(directory, pdb_id, bond_lengths, angle_params, torsion_params, affinity_dict, output_directory):
    """
...
if __name__ == "__main__":
    # data_directory = './coreset'  # 数据目录，包含各PDB ID文件夹和extracted_data.txt
    # output_directory = './features_matrices_3_2'  # 输出目录，保存特征矩阵
    data_directory = './case_study'
    output_directory = './res_5_19'
    os.makedirs(output_directory, exist_ok=True)
    save_features_to_files_sequential(data_directory, output_directory)
    print(f"Features saved to {output_directory}")
